...
void GLTexture3App::Render()
{
    ...
    {
        mTexMixRatio = ((float)mCount)*2/ kMaxCount;
    }
    else
    {
        mTexMixRatio = ((float)(kMaxCount - mCount))*2/ kMaxCount;
    }
    glUniform1f(glGetUniformLocation(mProgramObject, "mixRatio"), mTexMixRatio);
