...
class GLLightSpotApp : public GLBaseApp
{
    public:
        GLLightSpotApp(){};
        ~GLLightSpotApp(){};
    ...
    private:
        ...
        glm::vec3 mViewPos    = glm::vec3(0.0f, 0.0f, 2.5f);

        glm::vec3 mGoldAmbient = glm::vec3(0.5f, 0.5f, 0.5f);
