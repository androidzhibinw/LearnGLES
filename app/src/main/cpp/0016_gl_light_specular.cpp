...
void GLLightSpecularApp::Initialize()
{
    mRotation = 0.0f;
    ...
    glEnable(GL_DEPTH_TEST);
     ...
     {
        #include "shaders/include/0016_cube_v.glsl.in"
     };

    const char* vLightShaderStr=
     {
        #include "shaders/include/0016_light_v.glsl.in"
     };

     const char* fCubeShaderStr=
     {
        #include "shaders/include/0016_cube_f.glsl.in"
     };
 
    const char* fLightShaderStr=
     {
        #include "shaders/include/0016_light_f.glsl.in"
     };
...
void GLLightSpecularApp::Render()
{
